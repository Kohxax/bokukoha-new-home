  ...
  <div class="relative">
    ...
    >
      <div class="flex flex-col items-center justify-center space-y-4">
        ...
        <NuxtLink
          to="/about"
          class="space-y-3 transition-colors hover:opacity-85 duration-300 group"
        >
          <h1
          ...
          >
            Koha
            <span
              class="absolute bottom-0 left-0 h-0.5 bg-foreground transition-all duration-300 ease-out w-full md:w-0 md:group-hover:w-full"
            ></span>
          </h1>
