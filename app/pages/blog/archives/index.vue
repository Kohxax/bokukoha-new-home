        ...
        <template v-if="!year && !category">
            ...
            <section class="mb-12">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    <NuxtLink v-for="cat in categories" :key="cat.category"
            ...
            <section>
                ...
                <div class="flex flex-col gap-4">
                    <NuxtLink v-for="y in years" :key="y.year" :to="`/blog/archives?year=${y.year}`"
        ...
        <template v-else>
            <div style="view-transition-name: blog-content">
                ...
                <div v-if="filteredPosts.length" class="space-y-5">
                    <Card v-for="post in filteredPosts" :key="post.path"
